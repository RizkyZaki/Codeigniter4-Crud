                ...
                <div class="row mx-2">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="message-control form-control"
                                                    name="message">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum, quos?</textarea>
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-12 -->
                    ...
                    <div class="col-lg-6">
                        <div class="block-card dashboard-card mb-4">
                            ...
                            <div class="block-card-body">
                                <a href="" class="btn-danger btn border-0 text-white">Delete<i class="las la-user-minus ml-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
